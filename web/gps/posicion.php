...
//$notelefono = $_REQUEST['notelefeno'];
...
$q=mysql_query("UPDATE  unidad SET lat='$lat',longi='$long',id_device='$id_device', updated_at=DATE_SUB(NOW(),INTERVAL 1 HOUR) WHERE
                id_device='".$id_device."'");
//echo $id_device;				
//echo "UPDATE  unidad SET lat='$lat',longi='$long',id_device='$id_device', updated_at= '".date( "H-M-S", mktime(date("M")-1,0,0,0,0,0))."' WHERE

...
/**
 * EmpleadoEmpresa filter form base class.
 *
 * @package    sistem-taxi
 * @subpackage filter
 ...
 */
abstract class BaseEmpleadoEmpresaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'segundo_nombre'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'primer_apellido'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'segundo_apellido' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->widgetSchema->setNameFormat('empleado_empresa_filters[%s]');

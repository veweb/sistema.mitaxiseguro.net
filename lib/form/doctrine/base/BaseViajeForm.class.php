 ...
 */
abstract class BaseViajeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'mensaje_unidad_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('UnidadMensaje'), 'add_empty' => false)),

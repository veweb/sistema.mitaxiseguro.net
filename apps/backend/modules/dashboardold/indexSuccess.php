...
matched = jQuery.uaMatch( navigator.userAgent ); q browser = {};
...
<form name="datos" id="datos" action="<?php echo url_for('dashboardS/index'); ?>" method="POST">
				<div id="bodytop">
  ...
  callAjax2();
            ...
            if(pC !== "" && pD !== "" ){
              ...
              var request = { 
                            origin:start, 
                            destination:end,
                            waypoints:[{location: pC}, {location: pD}],

...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/homepages/10/d452294499/htdocs/web-mitaxiseguro/sistem-taxi/log/backend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/homepages/10/d452294499/htdocs/web-mitaxiseguro/sistem-taxi/cache/backend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/homepages/10/d452294499/htdocs/web-mitaxiseguro/sistem-taxi/apps/backend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/homepages/10/d452294499/htdocs/web-mitaxiseguro/sistem-taxi/cache/backend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/homepages/10/d452294499/htdocs/web-mitaxiseguro/sistem-taxi/apps/backend/template',
)));
